...
$X$ is the number of positive Rh infants until the first negative Rh infant. Then $X \sim NBinom(1,0.15) = Geom(0.15)$. We are assuming that there is a fixed number of trials, 1. There are two outcomes, positive and negative. The probability of a negative is the same in each trial. Finally, that each trial is independent. 
